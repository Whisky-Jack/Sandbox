...
curr_dir = "/home/josh/ML/simple_shapes/root"
...
circ_red_dir = curr_dir + "/circle"
circ_blue_dir = curr_dir + "/circle"
circ_green_dir = curr_dir + "/circle"

square_red_dir = curr_dir + "/square"
square_blue_dir = curr_dir + "/square"
square_green_dir = curr_dir + "/square"

triangle_red_dir = curr_dir + "/triangle"
triangle_blue_dir =curr_dir + "/triangle"
triangle_green_dir = curr_dir + "/triangle"
...
df.to_csv("./testFile.csv", sep=",", index=False)
